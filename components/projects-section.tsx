...
const projects = [
  {
    title: "NICODECK",
    description:
      "Macropad customizado com display LCD e integracao com OBS. Controle total sobre suas lives.",
  ...
  },
  {
    title: "TECLADO SPLIT",
    description:
      "Teclado ergonomico split com layout ortolinear, firmware QMK e case impressa em 3D.",
  ...
  {
    title: "IMPRESSAO 3D",
    description: "Ender 3 modificada com Direct Drive e Klipper.",
  ...
  },
  {
    title: "AUTOMACAO",
    description:
      "Homelab com servidores Debian, Docker containers, automacoes e monitoramento.",
