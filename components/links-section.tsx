...
const links = [
  {
    ...
    url: "/twitch",
    icon: Twitch,
    description: "LIVES DE CODING E GAMES",
    color: "#9146ff",
    hoverBg: "hover:bg-[#9146ffaa]",
  },
  {
    name: "YOUTUBE",
    url: "/youtube",
    icon: Youtube,
    description: "UNBOXING E PROJETOS",
    color: "#ff0000",
    hoverBg: "hover:bg-[#ff0000aa]",
  },
  {
    name: "GITHUB",
    url: "/github",
    icon: Github,
    description: "MEUS CÓDIGOS",
    color: "#00ff88",
    hoverBg: "hover:bg-[#00ff88aa]",
  },
  {
    name: "INSTAGRAM",
    url: "/instagram",
          ...
          {links.map((link, index) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h3
                  className="font-[family-name:var(--font-pixel)] text-sm mb-1 group-hover:text-[#0a0a12]"
