...
export function HeroSection() {
  ...
  const fullText = "DEV & CRIADORA DE CONTEUDO"
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden scanlines">
      ...
      <div className="absolute top-20 left-10 w-4 h-4 bg-[#00ffff] animate-float" style={{ animationDelay: '0s' }} />
      <div className="absolute top-40 right-20 w-3 h-3 bg-[#ff00ff] animate-float" style={{ animationDelay: '0.5s' }} />
      <div className="absolute bottom-40 left-20 w-5 h-5 bg-[#00ff88] animate-float" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-20 right-10 w-4 h-4 bg-[#ffff00] animate-float" style={{ animationDelay: '1.5s' }} />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="font-[family-name:var(--font-retro)] text-2xl md:text-3xl text-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          Transformando ideias em realidade atraves de codigo, hardware e criatividade. 
          Do terminal a bancada, da impressora 3D ao streaming.
        </p>
